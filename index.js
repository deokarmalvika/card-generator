...
(function ($){
    var dummy = '<div data-object-group="%">' +
        ...
        '<div class="form-group"><label for="background-image-opacity-%">Прозрачность</label><input type="text" id="background-image-opacity-%" name="blocks[%][background-image-opacity]" value=""/></div>' +
